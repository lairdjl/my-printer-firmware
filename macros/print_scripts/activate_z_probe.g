...
M400
M558 P8 C"^zprobe.in" H10 F1200 T18000 A5 S0.01 B1; set Z probe type to modulated and the dive height + speeds
G31 P500 X0 Y25 Z0.54 ; inductive probe offset, not critical, only used for coarse homing
G4 P200
